...
export const Hero: React.FC<HeroProps> = ({ language, onQuickStartTriage }) => {
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl border-2 border-slate-800 bg-slate-900">
              ...
              <div className="absolute top-4 left-4 bg-slate-900/90 backdrop-blur-md px-4 py-2.5 rounded-2xl shadow-xl border border-slate-700/80 flex items-center gap-3">
                <div className="w-3 h-3 rounded-full bg-cyan-400 animate-ping" />
                <div>
                  <div className="text-xs font-extrabold text-white">2,500+ PMDC Specialists</div>
                  <div className="text-[10px] text-cyan-300 font-medium">Available for Video Calls</div>
                </div>
              </div>

              {/* Floating Badge 2: AI Triage Counter */}
              <div className="absolute bottom-4 left-4 right-4 bg-slate-950/95 backdrop-blur-md p-4 rounded-2xl border border-slate-800 text-white flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs font-bold text-cyan-300">Free Instant Symptom Scan</div>
                  </div>
                </div>
